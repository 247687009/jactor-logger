...
public class PASemaphore {
    ...
    public PASemaphore(final Mailbox mbox, final int permitCount,int arraysize){
    	this(mbox,permitCount);
    	queue=new ArrayDeque<ResponseProcessor<Void>>(arraysize);
    }
    ...
    public PASemaphore(final Mailbox mbox, final int permitCount) {
        ...
        queue = new ArrayDeque<ResponseProcessor<Void>>();
